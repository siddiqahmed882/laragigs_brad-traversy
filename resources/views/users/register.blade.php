...
@section('content')
  <x-card class="mx-auto mt-24 max-w-lg p-10">
    ...
    <form action="/users" method="POST">
      ...
      <div class="mb-6">
        <label for="password" class="mb-2 inline-block text-lg">Password</label>
        <input 
          type="password" 
          id="password"
          class="w-full rounded border border-gray-200 p-2" 
      ...
      <div class="mb-6">
        <label for="password_confirmation" class="mb-2 inline-block text-lg">Confirm Password</label>
        <input 
          type="password" 
